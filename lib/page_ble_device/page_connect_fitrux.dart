...
class PageConnectFitruxBle extends StatefulWidget {
  const PageConnectFitruxBle({super.key});

  @override
  State<PageConnectFitruxBle> createState() => _PageConnectFitruxBle();
}

class _PageConnectFitruxBle extends State<PageConnectFitruxBle> with SingleTickerProviderStateMixin {
  // ignore: unused_field
