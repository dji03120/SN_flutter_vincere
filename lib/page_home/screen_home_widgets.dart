  ...
  Widget _buildHealthMetric(String label, double value, String unit) {
    return Column(
      children: [
        ...
        SizedBox(height: 2),
        Text(value.toString(), style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Colors.white)),
        SizedBox(height: 2),
            ...
            Row(
              ...
              children: [
                Container(
                  width: 90,
                  height: 90,
                  margin: EdgeInsets.fromLTRB(32, 24, 12, 24),
                ...
                Column(
                  ...
                  children: [
                    SizedBox(height: 24),
                    Row(
                      children: [SizedBox(width: 10), Text(user?["userNm"] ?? '', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)), SizedBox(width: 15), Text('만 ${calculateAge(userModel.userInfo?["bym"] ?? "정보없음").toString()}세', style: TextStyle(fontSize: 15, color: Colors.white))],
                    ),
                    SizedBox(height: 12),
                    TextButton(
                      onPressed: () {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(text: userModel.userHealthData?['muscleAge'].toString() ?? '--', style: const TextStyle(fontSize: 36, fontWeight: FontWeight.w800, color: Color(0xFF007130))),
...
Widget contentsCardActive(BuildContext context) {
  ...
  return Container(
    ...
    child: InkWell(
      ...
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (_) => const MyNutriCheck()));
      },
      child: Card(
        elevation: 6,
        color: Colors.white,
