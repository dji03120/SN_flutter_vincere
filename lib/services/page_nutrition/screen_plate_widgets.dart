...
import 'package:Vincere/services/page_nutrition/screen_nutrition_info_popup.dart';
...
//
//
class PlateRiceCard extends StatefulWidget {
  const PlateRiceCard({Key? key}) : super(key: key);

  @override
  _PlateRiceCard createState() => _PlateRiceCard();
}

class _PlateRiceCard extends State<PlateRiceCard> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    RiceWeightInput(
                        ...
                        onSubmit: (v) {
                          setState(() async {
                            await insertRiceIntake(userModel, "BREAKFAST", v);
                    ...
                    RiceWeightInput(
                        ...
                        onSubmit: (v) {
                          setState(() async {
                            await insertRiceIntake(userModel, "LUNCH", v);
                            await userModel.set_food_plate_data();
                          });
                        }),
                    const SizedBox(height: 8),
                    RiceWeightInput(
                        ...
                        onSubmit: (v) {
                          setState(() async {
                            await insertRiceIntake(userModel, "DINNER", v);
                            await userModel.set_food_plate_data();
                          });
                        }),
                  ],
