...
class PageInbodyBloodSugar extends StatefulWidget {
  const PageInbodyBloodSugar({super.key});

  @override
  State<PageInbodyBloodSugar> createState() => _PageInbodyBloodSugarState();
}

class _PageInbodyBloodSugarState extends State<PageInbodyBloodSugar> with SingleTickerProviderStateMixin {
  ...
  static const device_name = "BPBIO320_1640";
    ...
    try {
      final device = await bluetooth.requestDevice(
        RequestOptionsBuilder(
          [RequestFilterBuilder(namePrefix: "BPBIO320_1640")],
