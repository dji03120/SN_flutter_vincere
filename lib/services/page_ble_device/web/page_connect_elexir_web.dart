...
class PageConnectElexirWeb extends StatefulWidget {
  const PageConnectBle({super.key});

  @override
  State<PageConnectElexirWeb> createState() => _BLEPageState();
}

class _BLEPageState extends State<PageConnectElexirWeb> with SingleTickerProviderStateMixin {
