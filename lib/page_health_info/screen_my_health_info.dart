...
import 'package:Vincere/page_my_health/page_select_device.dart';
...
class _ScreenHealthInfo extends State<ScreenHealthInfo> {
  ...
  Future<void> _initializeData() async {
    try {
      ...
      _animateValue(
        userModel.userHealthData?['근육량'][0] ?? 0.0,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(height: 74, child: VerticalDivider(color: Colors.white.withOpacity(0.15), thickness: 1, width: 1)),
                  Container(margin: const EdgeInsets.fromLTRB(12, 12, 38, 24), child: _buildHealthMetric('근육량', animatedMuscle, 'kg')),
                ],
              ),
            ],
          ),
